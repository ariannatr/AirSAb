	...
	protected void configure(HttpSecurity http) throws Exception {
		http.
			authorizeRequests()
				...
				.antMatchers("/reservationslist").permitAll()
				.antMatchers("/resbyrenter").permitAll()
				.antMatchers("/downloadreservations","/downloadreservations/**").permitAll()
				.antMatchers("/critbyrenter").permitAll()
				.antMatchers("/critforowner").permitAll()
				.antMatchers("/downloadcriticsR","/downloadcriticsR/**").permitAll()
				.antMatchers("/downloadcriticsO","/downloadcriticsO/**").permitAll()
